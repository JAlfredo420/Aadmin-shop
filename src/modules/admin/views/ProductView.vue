<template>
    ...
    class="grid grid-cols-1 sm:grid-cols-2 bg-white px-5 gap-5">
        ...
        <div class="first-col">
            ...
            <div class="mb-4">
                ...
                <CustomInput
                v-model="slug" v-bind="slugAttrs" :error="errors.slug"
                />
            </div>
            ...
            <div class="mb-4">
                ...
                <CustomTextArea v-model="description"
                 v-bind="descriptionAttrs" :error="errors.description"></CustomTextArea>
            </div>
            ...
            <div class="flex flex-row gap-3">
                <div class="mb-4">
                    ...
                    <CustomInput
                    v-model.number="price"v-bind="priceAttrs" :error="errors.price"
                    />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <CustomInput
                    v-model.number="stock"v-bind="stockAttrs" :error="errors.stock"
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <button v-for="size of allSizes" key="size" 
    ...
    <div class="grid grid-cols-2 mt-2">
        ...
        <pre class="bg-purple-300 p-2 col-span-2">
